# DAHG – Level 2 Locathah Bard (College of Glamour)
## Core Concept
- **Race:** Locathah
...
You can always find a place to stay by offering encouragement, music, and kindness. Communities welcome you, and you can diffuse most tensions with your joyful presence. When you enter a settlement, you can find a place to rest and gather information without issue, often turning strangers into allies.
...
- **Jack of All Trades:** Add half your proficiency bonus (+1) to any ability check that doesn't already include a proficiency bonus.
- **Song of Rest:** During a short rest, creatures that hear your soothing music or oration regain an extra 1d6 hit points when spending Hit Dice to heal.

---

## College of Glamour Features (Level 3+)
- Not available at Level 2, but you can plan ahead: Mantle of Inspiration, Enthralling Performance (both fit Dahg’s style).

---

## Quick Combat Reference
- **AC:** 15 (Leather armor + Dex)
- **HP:** 17 (10 + 1d8 + Con mod)
...
- **Calm Emotions:** 60 ft, targets in 20 ft radius make Cha save or suppress strong emotions for 1 min, ending charm/fear/rage.
...
- Use Bardic Inspiration, Jack of All Trades, and spells to boost, heal, and encourage.
...
- Use Sleep, Calm Emotions, and non-lethal spells to avoid violence and resolve conflict peacefully.
- Take rests with Song of Rest, encourage downtime, and keep morale high.
- Use Insight to spot hidden needs and Persuasion to build community.

---

## Level-Up Suggestions
- **Level 3:** College of Glamour features (Mantle of Inspiration, Enthralling Performance), Expertise in skills.
- **Level 4:** Ability Score Improvement (e.g., +2 Charisma for more spellcasting oomph).
...
- Always encourage, invite, and uplift—now with more tools to help in unexpected ways.
- Avoid violence; use Calm Emotions, sleep, charm, and creative spells.
- Seek underdogs and outsiders—make them the main character, aided by your adaptable skills.
- Rest often with Song of Rest, and teach others the power of joy and downtime.
- Use your instrument as both tool and symbol of hope, now enhancing group recovery.

---

**Dahg is leveling up to bring even more joy, rest, and relentless encouragement to your campaign!**
